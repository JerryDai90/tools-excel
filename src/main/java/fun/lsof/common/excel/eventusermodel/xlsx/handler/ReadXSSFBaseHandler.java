...
import fun.lsof.common.excel.eventusermodel.xlsx.exception.ReadExcelException;
import fun.lsof.common.excel.eventusermodel.xlsx.exception.XlsContentImproperException;
import fun.lsof.common.excel.eventusermodel.xlsx.extern.SimpleCell;
import fun.lsof.common.excel.eventusermodel.xlsx.extern.SimpleRow;
...
public class ReadXSSFBaseHandler implements XSSFSheetXMLHandler.SheetContentsHandler {
    ...
    protected void initTitle() {
        ...
        if (title.containsAll(stencilTitle)) {
            ...
            throw new ReadExcelException(Assert.messageFormatter("在上传的excel中未找到title：{}", stencilTitle.toString()));
        }
    }
    ...
    public void parse() throws Exception {
        ...
        if (null == sheetRId) {
            throw new ReadExcelException(Assert.messageFormatter("未能在上传的excel中找到sheet：{}", sheetName));
        }
